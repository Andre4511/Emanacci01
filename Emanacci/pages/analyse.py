...
def render_analyse_page():
    ...
    st.markdown('<div class="em-section-sub">Einfache Einordnung für den aktuellen Markt</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="em-section-sub">Entry, Risiko und Ziele schnell planen</div>', unsafe_allow_html=True)
